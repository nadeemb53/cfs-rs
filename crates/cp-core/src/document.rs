...
impl Document {
    pub fn new(path: PathBuf, content: &[u8], mtime: i64) -> Self {
        ...
        // Spec CP-011: ID is generated from content hash
        // "The 16-byte ID is generated by taking the first 16 bytes of the BLAKE3 hash..."
        // Actually CP-003 says "ID is generated by taking the first 16 bytes of the BLAKE3 hash of this canonical UTF-8 byte stream." but that's for text.
        // For Documents, CP-002 says "id BLOB PRIMARY KEY -- 16 bytes (BLAKE3-16)".
        // CP-011 says `doc_id = generate_id(content_hash)`.
