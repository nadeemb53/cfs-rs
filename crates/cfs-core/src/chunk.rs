...
//!
//! Per CFS-011: Chunks use byte offsets and lengths for precise positioning.
...
///
/// Per CFS-011: Uses byte-based offsets (not character-based) for accurate
