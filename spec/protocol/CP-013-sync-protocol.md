# CP-013: Synchronization Protocol

> **Spec Version**: 1.0.0
> **Author**: Nadeem Bhati
> **Category**: Protocol
> **Requires**: CP-001, CP-002, CP-003

## Synopsis

This specification defines the synchronization protocol for CP, enabling encrypted state replication between devices via a blind relay server.
...
CP synchronization uses the following cryptographic algorithms:
...
CP V1 supports **Multi-Writer** operations, allowing any authorized device to ingest or modify content. Conflicts are resolved deterministically using **Hybrid Logical Clocks (HLC)** and **Last-Writer-Wins (LWW)** semantics.
