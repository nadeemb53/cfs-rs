...
This specification defines the document ingestion and indexing protocol for CP. It covers file parsing, chunking strategies, and index construction.
...
CP detects file types for appropriate parsing:
...
CP supports live file monitoring:
...
CP default uses **hybrid semantic chunking** with separator priority.
