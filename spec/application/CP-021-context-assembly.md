# CP-021: Context Assembly

> **Spec Version**: 1.0.0
> **Author**: Nadeem Bhati
> **Category**: Application
> **Requires**: CP-001, CP-012, CP-020

## Synopsis

This specification defines the deterministic context assembly algorithm for CP. Context assembly transforms retrieval results into a token-budgeted, ordered context window for intelligence modules.
