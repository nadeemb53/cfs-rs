# CP-020: Intelligence Interface

> **Spec Version**: 1.0.0
> **Author**: Nadeem Bhati
> **Category**: Application
> **Requires**: CP-001, CP-012

## Synopsis

This specification defines the interface contract between the CP substrate and Intelligence Modules (LLMs or other AI systems). It establishes formal boundaries that ensure the substrate remains the source of truth while intelligence operates as a read-only lens.
...
These constraints MUST be enforced by all CP implementations:
